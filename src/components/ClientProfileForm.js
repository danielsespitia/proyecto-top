...
const LinkToSanitaryRegister = styled.a`
  font-size: 16px;
  color: #2F80ED;
        ...
        <Desktopstructure>
          <BodyLeft>
            ...
            <TextSanitaryRegister> 
              <LinkToSanitaryRegister href="sanitary-register">Registro Sanitario</LinkToSanitaryRegister>
              {ReactDOM.createPortal(<h1>Registro</h1>, document.getElementById('modal'))}
            </TextSanitaryRegister>
            <PhotoClient 
